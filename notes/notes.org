...
- omp
  ...
  - det false, thread 1. few packets serial, parallel.
  - det false, thread 1. more packets serial, parallel.
  - det false, thread 2. few packets serial, parallel. if works, can cleanup omp
    code some.
  - det false, thread 2. more packets serial, parallel.
  - det false, thread 4. more packets serial, parallel.
  - det false, thread 8. more packets serial, parallel.
  - det false, thread 8. more packets serial, parallel.
  - repeat for mm_sim
