...
- velocity pred at real time! not slowed down like you do rosbag play
  - perf without prediction, doesn't seem like odoscan is doing /anything/
  - see if you can print out the estimated poses from lo_node
  - lookat lo_node to see how the vel estimate is applied
