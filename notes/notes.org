...
- mm sim meshes
  - removed heavy meshes from elements and reduced to 0.1 to create mm_version
    1. but even it took ~5s/packet. so going ahead with 010218 for now.
...
- profiling
  - O0, O2 for simple optimization
  - g, pg. then just give valgrind the executable
  - perf, operf for who is taking long etc
  - nvidia optix for raytracing
