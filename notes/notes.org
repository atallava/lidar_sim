...
- pcl. installed via package

- vtk. attempted package install. might not be sufficient. some clash between
  pcl and vtk packages.
...
- in scripts that matter
  - remove range data vizer
  - open each to compilation

- some scripts are to be removed

- then, in viz utils take out vtk

- then remove range data vizer from shared library
