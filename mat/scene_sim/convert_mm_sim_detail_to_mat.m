genRelPathSimDetail = @(sectionId,tag) ...
    sprintf('../../cpp/data/sections/section_%02d/mesh_model_sim/slice_sim_detail_%d.txt', ...
    sectionId,tag);

genRelPathSimDetailMat = @(sectionId,tag) ...
    sprintf('../data/sections/section_%02d/mesh_model_sim/slice_sim_detail_%d.mat', ...
    sectionId,tag);
