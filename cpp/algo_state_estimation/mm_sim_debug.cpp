...
#pragma omp for
	...
	algo_state_est::genRelPathPacketsToProcess(section_scans_id, scans_version, sim_type, mm_sim_version, debug);
	...
	algo_state_est::genRelPathRealPtsRef(section_scans_id, scans_version, sim_type, mm_sim_version, debug);
	...
	algo_state_est::genRelPathSimPts(section_scans_id, scans_version, sim_type, mm_sim_version, debug);
    writePtsToXYZFile(sim_pts, rel_path_sim_pts);

    // write sim detail
    std::string rel_path_sim_detail = 
	algo_state_est::genRelPathSimDetail(section_scans_id, scans_version, sim_type, mm_sim_version, debug);
