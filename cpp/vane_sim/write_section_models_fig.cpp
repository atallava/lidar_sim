...
std::string genRelPathFig(int section_id)
{
    std::ostringstream ss;
    ss << "figs/section_" << std::setw(2) << std::setfill('0') << section_id 
       << "_models.png";
...
int main(int argc, char **argv)
{
    ...
    vizer.writeActorsToFile(vizer.genSectionModelsActors(sim),
			    genRelPathFig(section_id));
