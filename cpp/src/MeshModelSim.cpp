...
// // load block info
// void MeshModelSim::loadBlockInfo(const std::string rel_path_imu_posn_nodes, const std::string rel_path_block_node_ids_ground, 
...
//     // todo: comment/ delete
//     // std::cout << "MeshModelSim: ellipsoid blocks hit: " << std::endl;
...
//     {
// 	std::stringstream ss_err_msg;
// 	ss_err_msg << "MeshModelSim: m_ellipsoid_model_sims is empty!";
// 	throw std::runtime_error(ss_err_msg.str().c_str());
//     }
